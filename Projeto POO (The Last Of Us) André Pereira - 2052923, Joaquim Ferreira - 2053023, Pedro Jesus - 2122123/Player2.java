...
public class Player2 extends Actor
{
    ...
    {
        for (int i = 0; i < 10; i++) {
            walkingRightImages[i] = new GreenfootImage("joel_walk_right_" + i + ".png");
            walkingLeftImages[i] = new GreenfootImage("joel_walk_left_" + i + ".png");
        }
        shootingRightImage = new GreenfootImage("joel_shoot_right.png");
        shootingLeftImage = new GreenfootImage("joel_shoot_left.png");
        idleRightImage = new GreenfootImage("joel_idle_right.png");
        idleLeftImage = new GreenfootImage("joel_idle_left.png");
    }
    ...
    private void checkThrowGrenade() {
        ...
        if (Greenfoot.isKeyDown("p") && grenadeCooldown == 0) {  
            ...
            GrenadeCounter grenadeCounter2 = world.getGrenadeCounter2();  // Acessa o contador de granadas do Player2

            if (grenadeCounter2.getGrenades() > 0) {
                throwGrenade();
                grenadeCounter2.useGrenade();  // Remove uma granada do inventário
    ...
    public void movePlayer() {
        ...
        if (Greenfoot.isKeyDown("up") && (onGround() || atWorldEdgeBottom())) {
            vSpeed = jumpHeight;
            fall();
        }

        if (Greenfoot.isKeyDown("enter") && !Shooting) {
    ...
    private void checkGrenadePickup() {
        ...
        if (grenade != null) {
            ...
            Boss_Room world = (Boss_Room) getWorld();
            world.getGrenadeCounter2().addGrenade();  // Adiciona uma granada ao contador do Player2
        }
    }
